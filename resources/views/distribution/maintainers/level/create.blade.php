...
<body class="bg-gray-100">
    ...
    <div class="max-w-6xl mx-auto p-6">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            <form action="{{ route('levels.store') }}" method="POST" class="p-6">
                @csrf

                <div class="mb-4">
                    <label for="nombre" class="block text-gray-700 font-bold mb-2">Número:</label>
            ...
            <a href="{{ route('levels.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded-lg">Cancelar</a>
        </div>
        </form>
