    ...
    <div id="HistoryModal"
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-slate-200 p-6 w-full max-w-4xl overflow-hidden">
            ...
            <div class="flex justify-between items-center mb-6 pb-4 border-b border-slate-100">
                <div>
                    <h2 class="text-xl font-bold text-slate-800">Historial de Pasillos</h2>
                    <p class="text-sm text-slate-500 mt-0.5">Registro de auditoría de creación y modificaciones de pasillos.</p>
                </div>
