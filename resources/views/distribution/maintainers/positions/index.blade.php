...
@section('content')
    ...
    <div id="showModal" class="hidden fixed inset-0 bg-black/30 flex items-center justify-center">
    ...
    <div id="HistoryModal"
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-slate-200 p-6 w-full max-w-4xl overflow-hidden">
            ...
            <div class="flex justify-between items-center mb-6 pb-4 border-b border-slate-100">
                <div>
                    <h2 class="text-xl font-bold text-slate-800">Historial de Posiciones</h2>
                    <p class="text-sm text-slate-500 mt-0.5">Registro de auditoría de creación y modificaciones de posiciones.</p>
                </div>
                <button type="button" onclick="closeHistory()" class="text-slate-400 hover:text-slate-600 p-1 rounded-lg hover:bg-slate-100 transition-colors">
                ...
                <table class="w-full text-left text-sm text-slate-600 whitespace-nowrap">
                    <thead class="bg-slate-50 text-slate-500 uppercase text-xs border-b border-slate-200 sticky top-0">
                        <tr>
                            ...
                            <th class="px-4 py-3 font-semibold">Detalle de la Posición</th>
                            <th class="px-4 py-3 font-semibold">Usuario Responsable</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-slate-100">
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            <td class="px-4 py-3 text-slate-500">16/09/2026 - 12:00</td>
                            <td class="px-4 py-3">
                                <span class="px-2.5 py-1 bg-emerald-100 text-emerald-800 rounded-full text-xs font-semibold">Creación</span>
                            </td>
                            <td class="px-4 py-3 font-medium text-slate-800">Posición A-01 (Posición de almacenamiento)</td>
                            <td class="px-4 py-3 text-slate-600 font-medium">Juan Pérez</td>
                        </tr>
                    </tbody>
                </table>
            </div>
