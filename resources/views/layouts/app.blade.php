    ...
    <aside id="sidebar"
        ...
        <div class="h-16 flex items-center px-6 border-b border-slate-800 bg-slate-900/80 backdrop-blur-sm shrink-0">
            <div class="flex items-center gap-2 font-bold text-xl text-white">
                <svg class="w-7 h-7 shrink-0 drop-shadow-sm" viewBox="0 0 32 32" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M 12 12 L 4 12 A 4 4 0 0 0 0 16 A 4 4 0 0 0 4 20 L 12 20 L 12 28 A 4 4 0 0 0 16 32 A 4 4 0 0 0 20 28 L 20 12 Z"
                        fill="#ffffff" />
        ...
        <nav class="flex-1 px-3 py-6 space-y-1 overflow-y-auto custom-scrollbar">
            ...
            <a href="{{ route('proveedores.index') }}"
                class="flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium transition-all duration-200 border-l-4 {{ request()->routeIs('proveedores.*') ? 'bg-blue-600/10 text-blue-400 border-blue-500' : 'text-slate-400 hover:bg-slate-800/50 hover:text-slate-200 border-transparent' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="{{ route('inventario.index') }}"
                class="flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium transition-all duration-200 border-l-4 {{ request()->routeIs('inventario.*') ? 'bg-blue-600/10 text-blue-400 border-blue-500' : 'text-slate-400 hover:bg-slate-800/50 hover:text-slate-200 border-transparent' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="{{ route('recepcion.index') }}"
                class="flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium transition-all duration-200 border-l-4 {{ request()->routeIs('recepcion.*') ? 'bg-blue-600/10 text-blue-400 border-blue-500' : 'text-slate-400 hover:bg-slate-800/50 hover:text-slate-200 border-transparent' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="{{ route('despacho.index') }}"
                class="flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium transition-all duration-200 border-l-4 {{ request()->routeIs('despacho.*') ? 'bg-blue-600/10 text-blue-400 border-blue-500' : 'text-slate-400 hover:bg-slate-800/50 hover:text-slate-200 border-transparent' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="{{ route('distribution.index') }}"
                class="flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium transition-all duration-200 border-l-4 {{ request()->routeIs('distribution.*') ? 'bg-blue-600/10 text-blue-400 border-blue-500' : 'text-slate-400 hover:bg-slate-800/50 hover:text-slate-200 border-transparent' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <p class="px-3 text-xs font-semibold text-slate-500 uppercase tracking-wider mt-6 mb-2">Control y Gestión
            </p>

            <!-- Trazabilidad -->
            <a href="{{ route('trazabilidad.index') }}"
                class="flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium transition-all duration-200 border-l-4 {{ request()->routeIs('trazabilidad.*') ? 'bg-blue-600/10 text-blue-400 border-blue-500' : 'text-slate-400 hover:bg-slate-800/50 hover:text-slate-200 border-transparent' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="{{ route('quarantine.index') }}"
                class="flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium transition-all duration-200 border-l-4 {{ request()->routeIs('quarantine.*') ? 'bg-blue-600/10 text-blue-400 border-blue-500' : 'text-slate-400 hover:bg-slate-800/50 hover:text-slate-200 border-transparent' }}">
            ...
            <a href="{{ route('reportes.index') }}"
                class="flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium transition-all duration-200 border-l-4 {{ request()->routeIs('reportes.*') ? 'bg-blue-600/10 text-blue-400 border-blue-500' : 'text-slate-400 hover:bg-slate-800/50 hover:text-slate-200 border-transparent' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="{{ route('qr.index') }}"
                class="flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium transition-all duration-200 border-l-4 {{ request()->routeIs('qr.*') ? 'bg-blue-600/10 text-blue-400 border-blue-500' : 'text-slate-400 hover:bg-slate-800/50 hover:text-slate-200 border-transparent' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            @role('Administrador')
                ...
                <a href="{{ route('users.index') }}"
                    class="flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium transition-all duration-200 border-l-4 {{ request()->routeIs('users.*') ? 'bg-blue-600/10 text-blue-400 border-blue-500' : 'text-slate-400 hover:bg-slate-800/50 hover:text-slate-200 border-transparent' }} mb-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="flex-1 flex flex-col min-w-0 overflow-hidden relative">
        ...
        <header
            ...
            <div class="flex items-center gap-4 w-full">
                <!-- Botón Menú Móvil -->
                <button onclick="toggleSidebar()"
                    class="p-2 -ml-2 text-slate-500 hover:bg-slate-100 hover:text-slate-700 rounded-lg lg:hidden transition-colors">
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="relative" id="notifications-container">
                    <button onclick="toggleNotifications()" type="button"
                        class="relative p-2 text-slate-400 hover:text-blue-600 transition-colors focus:outline-none rounded-full hover:bg-blue-50">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div id="notifications-menu"
                        ...
                        <div
                            ...
                            <span
                                class="bg-blue-100 text-blue-700 text-[10px] uppercase font-bold px-2 py-0.5 rounded-full">2
                                Nuevas</span>
                        </div>
                        <div class="max-h-80 overflow-y-auto">
                            <a href="#"
                                class="block px-4 py-3 hover:bg-slate-50 border-b border-slate-50 transition-colors bg-blue-50/30">
                                <div class="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-slate-600 mt-0.5 leading-relaxed">La orden de compra
                                            #4829 fue ingresada a bodega principal.</p>
                                        <p class="text-[10px] font-medium text-blue-500 mt-1">Hace 5 min</p>
                                    </div>
                                </div>
                            </a>
                            <a href="#"
                                class="block px-4 py-3 hover:bg-slate-50 border-b border-slate-50 transition-colors">
                                <div class="flex gap-3">
                                    <div
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-slate-600 mt-0.5 leading-relaxed">Paracetamol 500mg está
                                            por debajo del inventario mínimo.</p>
                        ...
                        <a href="#"
                            class="block px-4 py-3 text-center text-xs text-blue-600 font-semibold hover:bg-slate-50 transition-colors border-t border-slate-100">
                ...
                <div class="relative" id="user-menu-container">
                    <button onclick="toggleUserMenu()" type="button"
                        ...
                        <div
                            class="w-9 h-9 rounded-full bg-gradient-to-br from-blue-600 to-indigo-700 text-white flex items-center justify-center font-bold text-sm shadow-sm group-hover:ring-2 group-hover:ring-blue-200 transition-all">
                            <!-- Extrae la primeras letra del nombre y la pone en mayúscula -->
