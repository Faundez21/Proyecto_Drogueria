                ...
                <div class="space-y-6 flex-1">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-blue-200">Crea etiquetas para agilizar la identificación de productos</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        <div class="bg-blue-800/50 p-3 rounded-full border border-blue-600/30 shrink-0">
                            <svg class="w-6 h-6 text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"></path></svg>
                        </div>
                        <div>
                            <h3 class="font-semibold text-lg">Recepción y Despacho</h3>
                            <p class="text-sm text-blue-200">Controla el flujo de mercancía entrante y saliente al instante</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-blue-200">Gestiona usuarios, proveedores y zonas de cuarentena de forma segura</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center items-center p-6 sm:p-10 lg:p-16 relative">
            ...
            <div class="w-full max-w-md">
                ...
                <p class="mt-6 sm:mt-8 text-center text-xs sm:text-sm text-gray-600">
                    ¿No tienes una cuenta? <a href="mailto:nsanhueza@it.ucsc.cl" class="font-medium text-blue-700 hover:text-blue-900">Contacta al administrador</a>
                </p>
            </div>
