...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm relative overflow-hidden group">
            <div
                class="absolute right-0 top-0 w-24 h-24 bg-blue-50 rounded-bl-full -mr-8 -mt-8 transition-transform group-hover:scale-110">
            </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm relative overflow-hidden group">
            <div
                class="absolute right-0 top-0 w-24 h-24 bg-emerald-50 rounded-bl-full -mr-8 -mt-8 transition-transform group-hover:scale-110">
            </div>
            <div class="relative flex items-start justify-between">
                <div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm relative overflow-hidden group">
            <div
                class="absolute right-0 top-0 w-24 h-24 bg-purple-50 rounded-bl-full -mr-8 -mt-8 transition-transform group-hover:scale-110">
            </div>
            <div class="relative flex items-start justify-between">
                <div>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm">
        ...
        <div class="p-5 border-b border-slate-200 flex flex-col lg:flex-row justify-between items-center gap-4">
            ...
            <div class="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
                ...
                <select
                    class="py-2.5 px-4 bg-white border border-slate-200 rounded-xl text-sm font-medium text-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-sm w-full sm:w-auto">
            ...
            <div class="w-full lg:w-auto flex justify-end">
                <a href="{{ route('proveedores.create') }}"
                    class="w-full lg:w-auto bg-slate-900 text-white px-5 py-2.5 rounded-xl text-sm font-semibold hover:bg-slate-800 flex items-center justify-center gap-2 transition-all shadow-sm focus:ring-2 focus:ring-slate-900 focus:ring-offset-2">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse whitespace-nowrap">
                <thead>
                    <tr
                        class="bg-slate-50 border-b border-slate-200 text-slate-500 text-[11px] uppercase tracking-widest font-bold">
                ...
                <tbody class="divide-y divide-slate-100 text-sm">
                    ...
                    <tr class="hover:bg-slate-50/80 transition-colors group">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-11 h-11 rounded-full bg-gradient-to-br from-blue-500 to-blue-700 text-white flex items-center justify-center font-bold text-sm shadow-sm">
                                    LA
                                </div>
                                <div>
                        ...
                        <td class="px-6 py-4">
                            <span
                                class="inline-flex px-3 py-1 rounded-md text-xs font-semibold bg-indigo-50 text-indigo-700 border border-indigo-100">
                        ...
                        <td class="px-6 py-4 text-right relative">
                            <!-- Menú tres puntos -->
                            <button
                                class="btn-menu p-2 text-slate-400 hover:text-slate-700 hover:bg-slate-100 rounded-lg transition-colors"
                                data-target="menu-1">
                            ...
                            <!-- Dropdown -->
                            <div id="menu-1"
                                class="dropdown-menu hidden absolute right-8 top-12 w-48 bg-white rounded-xl shadow-lg shadow-slate-200/50 border border-slate-100 py-2 z-10 text-left">
                                <a href="#"
                                    class="flex items-center gap-2 px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 hover:text-blue-600 transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <tr class="hover:bg-slate-50/80 transition-colors group">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-11 h-11 rounded-full bg-gradient-to-br from-orange-400 to-orange-600 text-white flex items-center justify-center font-bold text-sm shadow-sm">
                                    IM
                                </div>
                                <div>
                        ...
                        <td class="px-6 py-4">
                            <span
                                class="inline-flex px-3 py-1 rounded-md text-xs font-semibold bg-blue-50 text-blue-700 border border-blue-100">
                                Insumos Clínicos
                            </span>
                        </td>
                        <td class="px-6 py-4 text-center">
                    ...
                    <tr class="hover:bg-slate-50/80 transition-colors opacity-75">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-11 h-11 rounded-full bg-slate-200 text-slate-500 flex items-center justify-center font-bold text-sm border border-slate-300">
                                    EQ
                                </div>
                                <div>
                        ...
                        <td class="px-6 py-4">
                            <span
                                class="inline-flex px-3 py-1 rounded-md text-xs font-semibold bg-slate-100 text-slate-600 border border-slate-200">
                                Equipamiento Mayor
                            </span>
                        </td>
                        <td class="px-6 py-4 text-center">
        ...
        <div
            ...
            <span class="text-sm text-slate-500">Mostrando del <span class="font-medium text-slate-900">1</span> al <span
                    class="font-medium text-slate-900">10</span> de <span class="font-medium text-slate-900">142</span>
                proveedores</span>
    ...
    <div id="HistoryModal"
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-slate-200 p-6 w-full max-w-4xl overflow-hidden">
            ...
            <div class="flex justify-between items-center mb-6 pb-4 border-b border-slate-100">
                <div>
                    <h2 class="text-xl font-bold text-slate-800">Historial de Registro de Proveedores</h2>
                    <p class="text-sm text-slate-500 mt-0.5">Auditoría de altas, modificaciones y bajas de proveedores.</p>
                </div>
                ...
                <table class="w-full text-left text-sm text-slate-600 whitespace-nowrap">
                    <thead class="bg-slate-50 text-slate-500 uppercase text-xs border-b border-slate-200 sticky top-0">
                        <tr>
                            ...
                            <th class="px-4 py-3 font-semibold">Proveedor / Detalle</th>
                            <th class="px-4 py-3 font-semibold">Usuario</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-slate-100">
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            <td class="px-4 py-3 text-slate-500">15/09/2026 - 10:50</td>
                            <td class="px-4 py-3">
                                <span
                                    class="px-2.5 py-1 bg-blue-100 text-blue-800 rounded-full text-xs font-semibold">Registro</span>
                            </td>
                            <td class="px-4 py-3 font-medium text-slate-800">Laboratorios Andinos S.A.</td>
                            <td class="px-4 py-3 text-slate-600">
                                Juan Pérez
                            </td>
                        </tr>
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            <td class="px-4 py-3 text-slate-500">10/09/2026 - 13:15</td>
                            <td class="px-4 py-3">
                                <span
                                    class="px-2.5 py-1 bg-blue-100 text-blue-800 rounded-full text-xs font-semibold">Registro</span>
                            </td>
                            <td class="px-4 py-3 font-medium text-slate-800">Insumos Médicos Sur SpA</td>
                            <td class="px-4 py-3 text-slate-600">
                                Juan Pérez
                            </td>
                        </tr>
    ...
    <script>
        ...
        //Script de historial de proveedores
